...
def make_synth_multi() -> Path:
    ...
    d.text((60, H - 60), "Generated for Dawa Dost eval. Non-clinical fixture.", fill="#999", font=f_footer)
...
def make_label_paracetamol() -> Path:
    ...
    d.text((40, 305), "Generated for Dawa Dost eval. Non-clinical fixture.", fill="#999", font=f_small)
